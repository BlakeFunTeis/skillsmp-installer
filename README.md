...
```sh
$skill-installer https://github.com/BlakeFunTeis/skillsmp-installer
```
...
1. 在環境變數中設定 `SKILL_MAP_API_KEY`（SkillsMP 的 API key）。
...
1. Set `SKILL_MAP_API_KEY` in your environment (SkillsMP API key).
